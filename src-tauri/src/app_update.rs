...
const DEFAULT_RELEASES_API_URL: &str =
    "https://api.github.com/repos/363637570yy-lab/qnwork/releases/latest";
const DEFAULT_RELEASES_HTML_URL: &str = "https://github.com/363637570yy-lab/qnwork/releases/latest";
const DEFAULT_RELEASES_PAGE: &str = "https://github.com/363637570yy-lab/qnwork/releases";
    ...
    if status == 200 {
        ...
        if let Some(idx) = body.find("/releases/tag/") {
            ...
            if let Some(tag) = extract_tag_from_release_url(&format!("https://github.com{slice}")) {
                ...
                let html = format!("https://github.com/363637570yy-lab/qnwork/releases/tag/{tag_path}");
