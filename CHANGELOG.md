...
> **Highlight:** First QNwork Windows build — own name, icon, and GitHub release channel.
>
> **中文 · 亮点：** 第一版 QNwork Windows 包：名称、图标与发布仓库已独立。

### Added
- The desktop app is named QNwork, with the cube QN icon.
- Updates and GitHub links point at this repository.

**中文 · 新增**
- 桌面端产品名改为 QNwork，并换上 QN 立方体图标。
- 检查更新与仓库链接指向本仓。
